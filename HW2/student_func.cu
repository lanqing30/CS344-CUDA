...
{
  std::cout << "cols:" << numCols << " rows:" << numRows << std::endl;
//TODO: Set reasonable block size (i.e., number of threads per block)
  ...
  cout << "grid_size: " <<  ceil((float)numCols / m) << " and  " << ceil((float)numRows / m) << endl;
  ...
  gaussian_blur<<<gridSize, blockSize, sizeof(int) * filterWidth * filterWidth>>>(d_red, d_redBlurred, numRows, numCols, d_filter, filterWidth);
  gaussian_blur<<<gridSize, blockSize, sizeof(int) * filterWidth * filterWidth>>>(d_green, d_greenBlurred, numRows, numCols, d_filter, filterWidth);
  gaussian_blur<<<gridSize, blockSize, sizeof(int) * filterWidth * filterWidth>>>(d_blue, d_blueBlurred, numRows, numCols, d_filter, filterWidth);
